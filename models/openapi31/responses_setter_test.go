...
func TestResponses_SetDefault_WithoutHook(t *testing.T) {
	...
	ref := shared.NewRefWithMeta[Response]("#/components/responses/default")
...
func TestResponses_SetCodes_WithoutHook(t *testing.T) {
	r := NewResponses(nil, nil)
	codes := map[string]*shared.RefWithMeta[Response]{"200": shared.NewRefWithMeta[Response]("#/components/responses/ok")}
