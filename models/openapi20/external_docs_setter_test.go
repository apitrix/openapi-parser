...
func TestExternalDocs_SetDescription_WithoutHook(t *testing.T) {
	ed := NewExternalDocs("old", "http://x.com")
...
func TestExternalDocs_SetDescription_WithHook_Rejects(t *testing.T) {
	ed := NewExternalDocs("old", "http://x.com")
...
func TestExternalDocs_SetDescription_WithHook_Passes(t *testing.T) {
	ed := NewExternalDocs("old", "http://x.com")
	ed.Trix.OnSet("description", func(field string, oldVal, newVal interface{}) error {
		return nil
	})
...
func TestExternalDocs_SetURL_WithoutHook(t *testing.T) {
	ed := NewExternalDocs("desc", "http://old.com")
...
func TestExternalDocs_SetURL_WithHook_Rejects(t *testing.T) {
	ed := NewExternalDocs("desc", "http://old.com")
	rejectErr := errors.New("rejected")
...
func TestExternalDocs_SetURL_WithHook_Passes(t *testing.T) {
	ed := NewExternalDocs("desc", "http://old.com")
	ed.Trix.OnSet("url", func(field string, oldVal, newVal interface{}) error {
		return nil
	})
