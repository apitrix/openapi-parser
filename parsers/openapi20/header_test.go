...
`
	...
	header := doc.Paths.Items["/pets"].Get.Responses.Codes["200"].Value.Headers["X-Request-ID"]
...
`
	...
	// Assert
	require.NoError(t, err)
	header := doc.Paths.Items["/pets"].Get.Responses.Codes["200"].Value.Headers["X-Rate-Limit"]
...
`
	...
	// Assert
	require.NoError(t, err)
	header := doc.Paths.Items["/pets"].Get.Responses.Codes["200"].Value.Headers["X-Limit"]
...
`
	...
	// Assert
	require.NoError(t, err)
	header := doc.Paths.Items["/pets"].Get.Responses.Codes["200"].Value.Headers["X-Tags"]
...
`
	...
	// Assert
	require.NoError(t, err)
	header := doc.Paths.Items["/pets"].Get.Responses.Codes["200"].Value.Headers["X-Status"]
...
`
	...
	// Assert
	require.NoError(t, err)
	header := doc.Paths.Items["/pets"].Get.Responses.Codes["200"].Value.Headers["X-Page-Size"]
