...
// known fields list and not extensions (x-*). Returns a slice of unknown fields.
func detectUnknownNodeFields(node *yaml.Node, knownFields []string, path string) []UnknownField {
