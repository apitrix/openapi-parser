...
func (p *schemaParser) ParseUnevaluatedItems(parent *yaml.Node, c *ParseContext) (*openapi31models.SchemaRef, error) {
...
func (p *schemaParser) ParseUnevaluatedProperties(parent *yaml.Node, c *ParseContext) (*openapi31models.SchemaRef, error) {
